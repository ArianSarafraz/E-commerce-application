...
function HomePage() {
  return (
    <>
      ...
      <div className="w-full h-4/5 flex justify-center items-center px-5 gap-x-10">
        ...
        <div className="w-full py-16 md:py-0 md:w-1/2 flex flex-col justify-center items-center">
          <h2 className="text-xl text-blue-50 ">
            ...
            cutting-edge electronics, featuring the latest gadgets and devices
            to enhance your lifestyle. Shop with us for quality, variety, and an
      ...
      <h2 className="text-5xl font-bold text-white text-center py-14">Fashion</h2>
      <HomeSection />
    </>
  );
}
